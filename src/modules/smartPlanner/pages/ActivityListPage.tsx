...
export default function ActivityListPage({
  ...
  const renderDropdown = () => {
    ...
    if (openDropdown === "sort") {
      return (
        <div className="absolute top-full mt-2 left-0 z-30 bg-card rounded-xl shadow-xl border border-border p-2 min-w-[220px] animate-in fade-in zoom-in-95 duration-150">
    ...
    if (openDropdown === "type") {
      return (
        <div className="absolute top-full mt-2 left-0 z-30 bg-card rounded-xl shadow-xl border border-border p-3 min-w-[260px] flex flex-col gap-1 animate-in fade-in zoom-in-95 duration-150">
    ...
    if (openDropdown === "duration") {
      return (
        <div className="absolute top-full mt-2 left-0 z-30 bg-card rounded-xl shadow-xl border border-border p-3 min-w-[220px] flex flex-col gap-1 animate-in fade-in zoom-in-95 duration-150">
    ...
    if (openDropdown === "price") {
      return (
        <div className="absolute top-full mt-2 left-0 z-30 bg-card rounded-xl shadow-xl border border-border p-5 min-w-[280px] flex flex-col gap-4 animate-in fade-in zoom-in-95 duration-150">
          <div>
